...
const config = {
  ...
  social: {
    ...
    skype: '',
    telegram: '',
    website: 'https://calendly.com/rtphawaii',
    phone: '',
    email: 'rpang16@gmail.com',
  },
  resume: {
    fileUrl:
      'https://docs.google.com/document/d/1tp7gmrFVxSYy8rKlh6qaBPr56BNby6ZD/edit?usp=sharing&ouid=106181217289032167190&rtpof=true&sd=true', // Empty fileUrl will hide the `Download Resume` button.
  },
  skills: [
    'Python',
    'R',
  ...
  externalProjects: [
    ...
    },{title: 'RAG System for Question Answering',
      description:
        'Retrieval augmented generation using Mistral 8B and Cohere + chunking and retrieval strategies and experimentation',
      imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHyNLe99XutGCe7Dz8SPx4UNQbgQYxJZFlUw&s',
      link: 'https://github.com/rtphawaii/RAG-System-For-QA/tree/main',
    },{title: 'Car Price Prediction Using Classical ML Models',
      description:
        'Linear Regression baseline improved by using many different ML models including neural networks, xgboost, random forests, and more',
      imageUrl: 'https://t4.ftcdn.net/jpg/03/98/18/19/360_F_398181949_BudYmmAeTPJwDz6HMxwf1PL3ZNIblohm.jpg',
